...
const Robot = () => {
    ...
    return (
        <>
            {/* <SkipNavContent> */}
            {/* <div className="absolute inset-0 bg-white w-4 rounded-s-full"></div> */}
            ...
            <div className="relative z-10 prose block w-full">
                <div
                    ref={instructions}
                    className="font-mono absolute z-20 w-full text-center text-2xl xl:text-3xl dark:drop-shadow-contrast unselectable duration-1000 transition-opacity min-w-4xl prose container max-w-6xl mx-auto text-balance"
                >
                    {/* prettier-ignore */}
                    <p
